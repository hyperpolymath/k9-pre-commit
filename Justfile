...
doctor:
    @echo "Running diagnostics for k9-pre-commit..."
...
heal:
    @echo "Attempting auto-repair for k9-pre-commit..."
...
help-me:
    @echo "=== k9-pre-commit Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/k9-pre-commit/issues/new"
    @echo ""
