...
// Replace k9-pre-commit, K9 Pre Commit — See README.adoc for details., just run, K9 Pre Commit started successfully. with actuals
= k9-pre-commit — Quick Start for Users
:toc:
:toclevels: 2

== What is k9-pre-commit?

K9 Pre Commit — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./k9-pre-commit-portable
----
...
[source]
----
K9 Pre Commit started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/k9-pre-commit/wiki
