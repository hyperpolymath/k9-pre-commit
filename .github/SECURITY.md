...
Replace all {{PLACEHOLDER}} values with your information:
  k9-pre-commit     - Your project name
  hyperpolymath            - GitHub username or org (e.g., hyperpolymath)
  k9-pre-commit             - Repository name
  j.d.a.jewell@open.ac.uk   - Security contact email
  {{PGP_FINGERPRINT}}  - Your PGP key fingerprint (40 chars, no spaces)
  {{PGP_KEY_URL}}      - URL to your public PGP key
  https://github.com/hyperpolymath/k9-pre-commit          - Your website/domain
...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/k9-pre-commit/security/advisories/new)
...
- This repository (`hyperpolymath/k9-pre-commit`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/k9-pre-commit/security/advisories)
...
When using k9-pre-commit, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/k9-pre-commit/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/k9-pre-commit/security/advisories/new) or j.d.a.jewell@open.ac.uk |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/k9-pre-commit/discussions) |
...
*Thank you for helping keep k9-pre-commit and its users safe.* 🛡️
