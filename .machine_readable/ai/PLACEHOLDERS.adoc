...
sed -i 's/k9-pre-commit/my-project/g' $(grep -rl 'k9-pre-commit' .)
...
| Placeholder | Description | Example | Files |
|---|---|---|---|
| `k9-pre-commit` | Human-readable project name | `My Project` | SECURITY.md, CODE_OF_CONDUCT.md, TOPOLOGY.md, STATE.a2ml, Justfile, GOVERNANCE.md, MAINTAINERS.md, flake.nix, devcontainer.json |
...
| `k9-pre-commit` | Repository name (slug) | `my-project` | CONTRIBUTING.md, SECURITY.md, CODE_OF_CONDUCT.md, cliff.toml |
...
| `https://github.com/hyperpolymath/k9-pre-commit` | Project website | `https://example.org` | SECURITY.md |
