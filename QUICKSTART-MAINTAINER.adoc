...
// Replace k9-pre-commit, {{PACKAGE_NAME}}, {{DEPS}} with actuals
= k9-pre-commit — Quick Start for Platform Maintainers
:toc:
:toclevels: 2

== Overview

This guide covers packaging, deploying, and maintaining k9-pre-commit for
...
* Upstream: https://github.com/hyperpolymath/k9-pre-commit/issues
