...
# k9-pre-commit container entrypoint
#
...
cleanup() {
    echo "Received shutdown signal — stopping k9-pre-commit..."
...
# Examples:
#   exec /app/k9-pre-commit
#   exec /app/release/bin/k9-pre-commit start
#   exec /app/k9-pre-commit serve --host "${APP_HOST}" --port "${APP_PORT}"
